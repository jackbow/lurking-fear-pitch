...
<section id="donate" class="flex flex-col justify-center items-center bg-white px-8 md:px-20 pb-12 h-screen gap-6">
  <h2 class="text-center text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-sans font-extrabold">Thank You</h2>
