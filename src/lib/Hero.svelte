...
/>
<div
  class="text-white absolute top-0 text-center left-0 w-full h-full bg-black bg-opacity-30 flex flex-col justify-center items-center gap-20 pb-32 font-extrabold space-y-0"
>
